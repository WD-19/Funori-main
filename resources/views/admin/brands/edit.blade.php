    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                @endif
                <form method="POST" action="{{ route('admin.brands.update', $brand) }}" class="form-grid"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group mb-3">
                        <label class="form-label fw-bold fs-5" for="name">Tên thương hiệu <span
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label fw-bold fs-5" for="logo">Logo (Để trống nếu không muốn thay đổi
                            ảnh)</label>
                        @if ($brand->logo_url)
                            <div class="mb-2">
                                <img src="{{ Storage::url($brand->logo_url) }}" alt="Logo hiện tại" width="80">
                            </div>
                        @endif
