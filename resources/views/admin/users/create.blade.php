                                            ...
                                            <fieldset class="mb-24">
                                                ...
                                                <div class="radio-buttons">
                                                    <div class="item">
                                                        ...
                                                        <label class="" for="apply-product1"><span class="body-title-2">Active</span></label>
                                                    </div>
                                                    <div class="item">
                                                        <input class="" type="radio" name="apply-product" id="apply-product2" checked>
                                                        <label class="" for="apply-product2"><span class="body-title-2">Inactive</span></label>
                                                    </div>
                                                    <div class="item">
                                                        <input class="" type="radio" name="apply-product" id="apply-product3" checked>
                                                        <label class="" for="apply-product2"><span class="body-title-2">Banned</span></label>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            <fieldset class="">
                                                ...
                                                <div class="radio-buttons">
                                                    <div class="item">
                                                        ...
                                                        <label class="" for="create-product1"><span class="body-title-2">Admin</span></label>
                                                    </div>
                                                    <div class="item">
                                                        <input class="" type="radio" name="create-product" id="create-product2" checked>
                                                        <label class="" for="create-product2"><span class="body-title-2">User</span></label>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </div>
