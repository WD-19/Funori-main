...
@section('content')
  <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- add-new-user -->
                                <form class="form-add-new-user form-style-2" enctype="multipart/form-data" method="POST" action="{{ route('admin.users.store') }}">
                                    @csrf
                                    <div class="wg-box">
                                        <div class="left">
                                            ...
                                            <div class="avatar-upload mt-3 mb-4">
                                                <label for="avatarInput">
                                                    <img src="{{ asset('images/images.jpg') }}" alt="Avatar" class="avatar-preview" id="avatarPreview">
                                                </label>
                                        ...
                                        <div class="right flex-grow">
                                            <fieldset class="name mb-24">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Username" name="full_name" tabindex="0" value="" aria-required="true" value="{{ old('full_name') }}" >
                                                @error('full_name')
                                                    <div class="text text-danger">{{ $message }}</div>
                                                @enderror
                                            </fieldset>
                                            <fieldset class="email mb-24">
                                                ...
                                                <input class="flex-grow" type="email" placeholder="Email" name="email" tabindex="0" value="" aria-required="true" value="{{ old('email') }}" >
                                                @error('email')
                                                    <div class="text text-danger">{{ $message }}</div>
                                                @enderror
                                            </fieldset>
                                            <fieldset class="phone mb-24">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Phone Number" name="phone_number" tabindex="0" value="{{ old('phone_number') }}" aria-required="true" >
                                                @error('phone_number')
                                                    <div class="text text-danger">{{ $message }}</div>
                                                @enderror
                                            </fieldset>
                                        ...
                                        <div class="right flex-grow">
                                            <fieldset class="mb-24">
                                                ...
                                                <div class="radio-buttons">
                                                    <div class="item">
                                                        <input type="radio" name="account_status" id="apply-product1" value="active" {{ old('account_status') == 'active' ? 'checked' : '' }}>
                                                        <label for="apply-product1"><span class="body-title-2">Active</span></label>
                                                    </div>
                                                    <div class="item">
                                                        <input type="radio" name="account_status" id="apply-product2" value="inactive" {{ old('account_status', 'inactive') == 'inactive' ? 'checked' : '' }}>
                                                        <label for="apply-product2"><span class="body-title-2">Inactive</span></label>
                                                    </div>
                                                    <div class="item">
                                                        <input type="radio" name="account_status" id="apply-product3" value="banned" {{ old('account_status') == 'banned' ? 'checked' : '' }}>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="radio-buttons">
                                                    <div class="item">
                                                        <input type="radio" name="role" id="create-product1" value="admin" {{ old('role') == 'admin' ? 'checked' : '' }}>
                                                        <label for="create-product1"><span class="body-title-2">Admin</span></label>
                                                    </div>
                                                    <div class="item">
                                                        <input type="radio" name="role" id="create-product2" value="user" {{ old('role', 'user') == 'user' ? 'checked' : '' }}>
