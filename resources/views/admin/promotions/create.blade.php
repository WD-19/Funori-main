...
<form class="form-add-promotion" method="POST" action="{{ route('admin.promotions.store') }}">
    ...
    <div class="wg-box mb-30">
        <fieldset class="name">
            ...
            <input class="mb-10" type="text" placeholder="Nhập tên khuyến mãi" name="name" maxlength="100" required value="{{ old('name') }}">
        </fieldset>
        <fieldset class="code">
            <div class="body-title mb-10">Mã khuyến mãi</div>
            <input class="mb-10" type="text" placeholder="Nhập mã" name="code" maxlength="50" value="{{ old('code') }}">
        </fieldset>
        ...
        <fieldset class="min_order_value">
            ...
            <input type="number" name="min_order_value" min="0" step="0.01" value="{{ old('min_order_value') }}">
        </fieldset>
        <fieldset class="usage_limit_per_voucher">
            <div class="body-title mb-10">Số lượt dùng tối đa cho mã</div>
            <input type="number" name="usage_limit_per_voucher" min="0" value="{{ old('usage_limit_per_voucher') }}">
        </fieldset>
        <fieldset class="usage_limit_per_user">
            <div class="body-title mb-10">Số lượt dùng tối đa mỗi người</div>
            <input type="number" name="usage_limit_per_user" min="0" value="{{ old('usage_limit_per_user') }}">
        </fieldset>
    ...
    <div class="cols gap10">
        ...
        <a href="{{ route('admin.promotions.index') }}" class="tf-button style-3 w380">Hủy</a>
    </div>
</form>
<script>
