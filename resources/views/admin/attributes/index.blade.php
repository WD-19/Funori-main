...
@section('content')
    ...
    <div class="wg-box">
        <div class="flex items-center justify-between gap10 flex-wrap">
            ...
            <a class="tf-button style-1 w208" href="{{ route('admin.attributes.create') }}"><i class="icon-plus"></i>Thêm
                mới</a>
        </div>
                    ...
                    <li class="attribute-item item-row flex items-center justify-between gap20">
                        ...
                        <div class="list-icon-function">
                            ...
                            <div class="item trash">
                                <form action="{{ route('admin.attributes.destroy', $attributeValue->id) }}" method="POST"
        ...
        <div class="flex items-center justify-between flex-wrap gap10">
            <div class="text-tiny">
                Hiển thị {{ $attributes->firstItem() }} đến {{ $attributes->lastItem() }} trên tổng số
