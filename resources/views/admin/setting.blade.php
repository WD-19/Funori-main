                            ...
                            <div class="cols gap24">
                                <fieldset class="mb-24">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="First Name" name="name"
                                        tabindex="0" value="Kristin" aria-required="true" required="">
                                </fieldset>
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Last Name</div>
                                    <input class="flex-grow" type="text" placeholder="Last Name" name="name"
                                        tabindex="0" value="Watson" aria-required="true" required="">
                                </fieldset>
                            </div>
                            <div class="cols gap24">
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Address</div>
                                    <input class="flex-grow" type="text" placeholder="Address" name="name"
                                        tabindex="0" value="52 Davis Street, Buffalo, New York" aria-required="true"
                                        required="">
                                </fieldset>
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Contact</div>
                                    <input class="flex-grow" type="text" placeholder="Contact" name="name"
                                        tabindex="0" value="+1 548 562 1023" aria-required="true" required="">
                                </fieldset>
                            </div>
                            <div class="cols gap24">
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Email</div>
                                    <input class="flex-grow" type="email" placeholder="Email" name="name"
                                        tabindex="0" value="kristin@ecomus.com" aria-required="true" required="">
                                </fieldset>
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Role</div>
                                    <input class="flex-grow" type="text" placeholder="Address" name="name"
                                        tabindex="0" value="Sale Administrator" aria-required="true" required="">
                                </fieldset>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="right flex-grow">
                            ...
                            <div class="cols gap24">
                                <fieldset class="mb-24">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="Enter Google Login ID"
                                        name="name" tabindex="0" value="" aria-required="true"
                                        required="">
                                </fieldset>
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Google Secret Key</div>
                                    <input class="flex-grow" type="text" placeholder="Enter Google Secret Key"
                                        name="name" tabindex="0" value="" aria-required="true"
                                        required="">
                                </fieldset>
                            </div>
                            <fieldset class="mb-24">
                                ...
                                <div class="radio-buttons">
                                    <div class="item">
                                        <input class="" type="radio" name="enable-facebook"
                                            id="enable-facebook1">
                                        <label class="" for="enable-facebook1"><span
                                                class="body-title-2">Yes</span></label>
                                    </div>
                                    <div class="item">
                                        <input class="" type="radio" name="enable-facebook"
                                            id="enable-facebook2" checked="">
                                        <label class="" for="enable-facebook2"><span
                                                class="body-title-2">No</span></label>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="cols gap24">
                                <fieldset class="mb-24">
                                    ...
                                    <input class="flex-grow" type="text" placeholder="Enter Facebook ID "
                                        name="name" tabindex="0" value="" aria-required="true"
                                        required="">
                                </fieldset>
                                <fieldset class="mb-24">
                                    <div class="body-title mb-10">Facebook Secret Key</div>
                                    <input class="flex-grow" type="text" placeholder="Enter Facebook Secret Key"
                                        name="name" tabindex="0" value="" aria-required="true"
                                        required="">
                                </fieldset>
                            </div>
