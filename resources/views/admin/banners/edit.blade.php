...
@section('content')
    ...
    <!-- form-add-Banner -->
    <form class="form-add-Banner" method="Post" enctype="multipart/form-data"
        ...
        <div class="wg-box mb-30">
            <fieldset class="img-edit1">
                ...
                <img src="{{ asset('storage/' . $banner->image_url) }}" alt="" class="img-edit">
        ...
        <div class="wg-box mb-30">
            <fieldset class="name">
                ...
                <input class="mb-10" type="text" placeholder="Enter title" name="link_url" tabindex="0"
                    value="{{ $banner->link_url }}" aria-required="true" required="">
            ...
            <fieldset class="name">
                ...
                <input class="mb-10" type="text" placeholder="Enter title" name="title" tabindex="0"
            ...
            <div class="cols-lg gap22">
                <fieldset class="price">
                    ...
                    <input class="" type="text" placeholder="Price" name="position" tabindex="0"
                        value="{{ $banner->position }}" aria-required="true" required="">
                </fieldset>
                <fieldset class="sale-price">
                    ...
                    <input class="" type="number" placeholder="Sale Price " name="order" tabindex="0"
                        value="{{ $banner->order }}" aria-required="true" required="">
                </fieldset>
                <fieldset class="sale-price">
                    <div class="body-title mb-10">is_active</div>
                    <select name="is_active" id="">
                        <option value="1" {{ $banner->is_active == 1 ? 'selected' : '' }}>Kích hoạt</option>
                        <option value="0" {{ $banner->is_active == 0 ? 'selected' : '' }}>Chưa kích hoạt</option>
                    </select>
                </fieldset>
        ...
        <div class="cols gap10">
            <button class="tf-button w380" type="submit">Update Banner</button>
