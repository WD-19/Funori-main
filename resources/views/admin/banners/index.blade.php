            ...
            <div class="wg-box">
                            ...
                            <fieldset>
                                <select name="position">
                                    ...
                                    @foreach ($positions as $pos)
                                        <option value="{{ $pos }}"
                                            @if (request('position') == $pos) selected @endif>
                                            {{ $pos }}</option>
                                    @endforeach
                                </select>
                            </fieldset>
                            <button class="tf-button w-50" type="submit">Áp dụng</button>
                        </form>
                    </div>
                ...
                <div class="wg-table table-all-category mt-2">
                    <ul class="table-title flex gap10 mb-14" style="background:#f3f4f6;">
                        ...
                        <li style="min-width:100px">
                            <div class="body-title">Vị trí</div>
                        </li>
                        <li style="min-width:70px">
                            <div class="body-title">Thứ tự</div>
                        </li>
                        <li style="min-width:180px">
                            <div class="body-title">Thời gian sử dụng</div>
                        </li>
                    ...
                    <ul class="flex flex-column">
                        @forelse($banners as $banner)
                            <li class="wg-product item-row gap10"
                                style="align-items:center; border-bottom:1px solid #eee; padding:12px 0;">
                                <div style="min-width:100px">
                                    <div class="image"
                                        style="width:60px;height:32px;border-radius:4px;overflow:hidden;background:#f3f4f6;">
                                ...
                                <div style="min-width:100px"><span class="badge bg-info">{{ $banner->position }}</span>
                                </div>
                                <div style="min-width:70px"><span
                                        class="badge bg-light text-dark">{{ $banner->order }}</span></div>
                                ...
                                <div class="list-icon-function" style="min-width:140px">
                                    <a href="{{ route('admin.banners.show', $banner->id) }}" class="item eye"
                                        title="Xem chi tiết"><i class="icon-eye"></i></a>
                                    ...
                                    <form method="post" action="{{ route('admin.banners.destroy', $banner->id) }}"
                                        onsubmit="return confirm('Xác nhận xóa?')" style="display:inline;">
                                        @csrf @method('DELETE')
                                        <button class="item trash" type="submit" title="Xóa"
