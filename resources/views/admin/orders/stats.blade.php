    ...
    <div class="container py-3">
        ...
        <div class="flex items-center flex-wrap justify-between gap20 mb-30">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Thống kê đơn hàng</div>
                </li>
            </ul>
        </div>
        <p class="text-muted mb-0 form-control rounded fs-2 mb-5">Cập nhật: {{ \Carbon\Carbon::now()->format('d/m/Y H:i') }}</p>
                    ...
                    <div class="card-body p-3">
                        ...
                        @if ($latestOrder)
                            ...
                            <div class="text-info fw-bold mb-1">
                                {{ number_format($latestOrder->total_amount, 0, ',', '.') }}₫
                            </div>
                            <div class="small text-muted">
                                {{ \Carbon\Carbon::parse($latestOrder->created_at)->format('d/m/Y H:i') }}</div>
                        @else
