        ...
        <div class="box-all-product">
            <div class="header-product">
                <form method="GET" id="sort-form" style="display:inline;">
                    ...
                    <select name="sort" id="box-all-list" onchange="document.getElementById('sort-form').submit()">
                        ...
                        <option value="popularity" {{ request('sort') == 'popularity' ? 'selected' : '' }}>Sort By
                            Popularity</option>
                        <option value="rating" {{ request('sort') == 'rating' ? 'selected' : '' }}>Sort By Average Rating
                        </option>
                        <option value="latest" {{ request('sort') == 'latest' ? 'selected' : '' }}>Sort By Latest</option>
                        <option value="price_asc" {{ request('sort') == 'price_asc' ? 'selected' : '' }}>Sort By Price: Low
                            To High</option>
                        <option value="price_desc" {{ request('sort') == 'price_desc' ? 'selected' : '' }}>Sort By Price:
                            High To Low</option>
                    </select>
                </form>
            </div>
            ...
            <div class="box-footer-product"
                ...
                <div class="box-percent" style="flex: 1; margin: 0 24px;">
                    <div class="in-percent"
                        style="height: 6px; background: #e0e0e0; border-radius: 3px; position: relative;">
                        <div
                            style="height: 100%; background: #fcad02; border-radius: 3px; width: {{ ($products->lastItem() / $products->total()) * 100 }}%; transition: width 0.3s;">
                        </div>
                    </div>
                </div>
