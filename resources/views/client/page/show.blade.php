    ...
    @if ($otherPosts->count())
        <div style="margin:48px auto 0 auto;max-width:1300px;">
                    ...
                    <div class="other-card">
                        <a href="{{ route('client.page.show', $item->slug) }}">
                            <img src="{{ $item->featured_image_url ? asset('storage/' . $item->featured_image_url) : asset('client/Picture/Blog/default.jpg') }}"
                                alt="{{ $item->meta_title }}" style="width:100%;height:120px;object-fit:cover;">
                            <div style="font-weight:600;margin:10px 0 6px 0;">{{ $item->meta_title }}</div>
                            <div
            ...
            <div style="text-align:center;margin-top:18px;">
                <a href="{{ route('client.page') }}" class="btn btn-outline-primary"
                ...
                @foreach ($suggestedProducts as $product)
                    <div class="product-card">
                        <a href="{{ route('client.product.show', $product->slug) }}">
                            <img src="{{ $product->image ? asset('storage/' . $product->image) : asset('client/Picture/Product/default.jpg') }}"
