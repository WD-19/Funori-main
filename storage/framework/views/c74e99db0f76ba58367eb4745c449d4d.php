...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box-banner-about-2">
        <div class="in-box-banner">
            <img src="<?php echo e(asset('client/Picture/Shop/banner-33.jpg')); ?>" alt="">
        </div>
    </div>
    <div class="box-introduce-1">
        <div class="box-picture">
            <img src="<?php echo e(asset('client/Picture/Shop/banner-34.jpg')); ?>" alt="">
        </div>
...
<?php echo $__env->make('client.layout.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Funori-main\resources\views/client/about/about.blade.php ENDPATH**/ ?>