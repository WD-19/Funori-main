            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    <div class="wg-filter flex-grow">
                        <form class="form-search flex gap10" method="GET" action="<?php echo e(route('admin.categories.index')); ?>">
                            <fieldset class="name">
                            ...
                            <fieldset>
                                <select name="is_active">
                                    ...
                                    <option value="1" <?php echo e(request('is_active') === '1' ? 'selected' : ''); ?>>Kích hoạt
                                    </option>
                                    <option value="0" <?php echo e(request('is_active') === '0' ? 'selected' : ''); ?>>Không kích
                                        hoạt</option>
                                </select>
                            </fieldset>
                    ...
                    <tbody>
                        <ul class="flex flex-column">
                            <?php if($isSearching): ?>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="attribute-item item-row flex items-center justify-between gap20">
                                        <div class="body-text"><?php echo e($categories->firstItem() + $loop->index); ?></div>
                                        <div class="name d-flex align-items-center">
                                            <span class="body-title-2"><?php echo e($category->name); ?></span>
                                        </div>
                                        <div class="body-text">
                                        ...
                                        <div class="list-icon-function">
                                            ...
                                            <div class="modal fade" id="quickViewModalParent<?php echo e($category->id); ?>"
                                                tabindex="-1" aria-labelledby="quickViewLabelParent<?php echo e($category->id); ?>"
                                                aria-hidden="true">
                                                        ...
                                                        <div class="modal-body px-5 py-4">
                                                            <div class="row gy-3">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <div class="text-muted">
                                                                        <?php echo e($category->created_at); ?></div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Ngày cập nhật:</strong>
                                                                    <div class="text-muted">
                                                                        <?php echo e($category->updated_at); ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="attribute-item item-row flex items-center justify-between gap20
                                        <?php echo e(request('new_id') == $category->id ? 'bg-warning bg-opacity-25 border border-warning' : ''); ?>"
                                        ...
                                        <div class="name d-flex align-items-center">
                                            <?php if($category->children->count()): ?>
                                                <button class="btn btn-sm btn-outline-secondary me-2" type="button"
                                                    ...
                                                    data-bs-target="#collapseChildren<?php echo e($category->id); ?>"
                                                    aria-expanded="false"
                                                    aria-controls="collapseChildren<?php echo e($category->id); ?>">
                                    ...
                                    <?php if($category->children->count()): ?>
                                        <li class="collapse" id="collapseChildren<?php echo e($category->id); ?>">
                                            <ul class="ms-5">
                                                <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li
                                                        class="attribute-item item-row flex items-center justify-between gap20
                                                        <?php echo e(request('new_id') == $child->id ? 'bg-warning bg-opacity-25 border border-warning' : ''); ?>">
                                                        <div class="body-text"><?php echo e($loop->iteration); ?></div>
                                                        <div class="name">
                                                            <span class="body-title-2"><?php echo e($child->name); ?></span>
                                                        </div>
                                                        <div class="body-text">
                                                        ...
                                                        <div class="list-icon-function">
                                                            ...
                                                            <div class="item eye" data-bs-toggle="modal"
                                                                data-bs-target="#quickViewModalParent<?php echo e($child->id); ?>">
                                                                <i class="icon-eye"></i>
                                                            </div>
                                                            <div class="modal fade"
                                                                id="quickViewModalParent<?php echo e($child->id); ?>"
                                                                tabindex="-1"
                                                                aria-labelledby="quickViewLabelParent<?php echo e($child->id); ?>"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                    <div class="modal-content shadow-lg rounded-4 border-0"
                                                                        style="font-size: 16px;">
                                                                        <div class="modal-header bg-primary text-white">
                                                                            <h3 class="modal-title fw-bold mb-0 text-light"
                                                                                id="quickViewLabelParent<?php echo e($child->id); ?>">
                                                                                <i class="bi bi-info-circle me-2"></i>Chi
                                                                                tiết danh mục
                                                                            </h3>
                                                                            <button type="button"
                                                                        ...
                                                                        <div class="modal-body px-5 py-4">
                                                                            <div class="row gy-3">
                                                                                <div class="col-sm-6">
                                                                                    <strong>Tên danh mục:</strong>
                                                                                    <div class="text-muted">
                                                                                        <?php echo e($child->name); ?></div>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <strong>Slug:</strong>
                                                                                    <div class="text-muted">
                                                                                        <?php echo e($child->slug); ?></div>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <strong>Danh mục cha:</strong>
                                                                                    <div class="text-muted">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <strong>Ngày tạo:</strong>
                                                                                    <div class="text-muted">
                                                                                        <?php echo e($child->created_at); ?></div>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <strong>Ngày cập nhật:</strong>
                                                                                    <div class="text-muted">
                                                                                        <?php echo e($child->updated_at); ?></div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="item edit">
                                                                <a
                                                                    href="<?php echo e(route('admin.categories.edit', $child->id)); ?>"><i
                                                                        class="icon-edit-3"></i></a>
                                                            </div>
                                                            <form
                                                                action="<?php echo e(route('admin.categories.destroy', $child->id)); ?>"
                                                                method="POST" style="display:inline;"
                                                                onclick="return confirm('Xóa danh mục này??');">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
