        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="<?php echo e(route('admin.products.create')); ?>"><i
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="wg-product item-row gap20">
                                ...
                                <div class="body-text text-main-dark mt-4">
                                    <?php echo e($product->variants->sum('id')); ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.products.update', $product->id)); ?>"
                                        ...
                                        <select name="status" onchange="this.form.submit()" style="max-width:200px;">
                                            <option value="published"
                                                <?php echo e($product->status == 'published' ? 'selected' : ''); ?>>Hiển thị</option>
                                            <option value="draft" <?php echo e($product->status == 'draft' ? 'selected' : ''); ?>>
                                                Ngừng Kinh doanh</option>
                                            <option value="archived"
                                                <?php echo e($product->status == 'archived' ? 'selected' : ''); ?>>Lưu trữ</option>
                                        </select>
                                    </form>
                                </div>
                                <div class="list-icon-function">
                                    <div class="item eye">
                                        <a href="<?php echo e(route('admin.products.show', $product->id)); ?>"><i
                                                class="icon-eye"></i></a>
                                    </div>
                                    <div class="item edit">
                                        <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>"><i
                ...
                <div class="flex items-center justify-between flex-wrap gap10">
                    <div class="text-tiny">
                        Hiển thị <?php echo e($products->firstItem()); ?> đến <?php echo e($products->lastItem()); ?> trên tổng số
