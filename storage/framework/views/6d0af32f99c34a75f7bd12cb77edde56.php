...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('admin.brands.store')); ?>" class="form-grid" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Funori-main\resources\views/admin/brands/create.blade.php ENDPATH**/ ?>