...
<form class="form-add-product" method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data">
    ...
    <div class="cols gap10">
        ...
        <a href="<?php echo e(route('admin.products.index')); ?>" class="tf-button style-3 w380">Hủy</a>
    </div>
</form>
...
<?php echo $__env->make('admin.layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Funori-main\resources\views/admin/products/create.blade.php ENDPATH**/ ?>